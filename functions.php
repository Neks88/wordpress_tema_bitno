...
function lapizzeria_setup () {
    ...
    // update_option("thumbnail_size_p", 165);
}
...
function lapizzeria_styles () {
    ...
    wp_register_style("googlefont", 'https://fonts.googleapis.com/css?family=Open+Sans:400,700|Raleway:300i,400,700,900&display=swap', array(), "1.0.0" );
    wp_register_style("normalize", get_template_directory_uri()."/css/normalize.css",array(), "8.0.1" );
    wp_register_style("fluidboxcss", get_template_directory_uri()."/css/fluidbox.min.css",array(), "2.0.5" );
